/**
 * Dialog for creating Zoom meetings
...
import { createZoomMeetingSchema, CreateZoomMeetingInput } from "@/lib/validation";
...
export function CreateZoomMeetingDialog({ trigger, onSuccess, open: controlledOpen, onOpenChange: controlledOnOpenChange }: CreateZoomMeetingDialogProps) {
  ...
  const onSubmit = async (data: CreateZoomMeetingInput) => {
    try {
      ...
      console.error('[CreateZoomMeetingDialog] Submit error:', error);
    }
  };
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Schedule a new Zoom meeting. Attendees will receive an invite.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="flex flex-col items-center justify-center py-4 text-center">
              ...
              <p className="text-sm text-muted-foreground max-w-sm">
                Your Zoom meeting has been scheduled. Share the link below with attendees.
              </p>
            </div>
