/**
 * Dialog for creating Google Meet meetings
...
import { useCreateGoogleMeetMeeting } from "@/hooks/useCreateGoogleMeetMeeting";
import { createGoogleMeetMeetingSchema, CreateGoogleMeetMeetingInput } from "@/lib/validation";
import { cn } from "@/lib/utils";

interface CreateGoogleMeetMeetingDialogProps {
...
export function CreateGoogleMeetMeetingDialog({ trigger, onSuccess, open: controlledOpen, onOpenChange: controlledOnOpenChange }: CreateGoogleMeetMeetingDialogProps) {
  ...
  const createMeeting = useCreateGoogleMeetMeeting();
  ...
  const form = useForm<CreateGoogleMeetMeetingInput>({
    resolver: zodResolver(createGoogleMeetMeetingSchema),
    defaultValues: {
      title: "",
  ...
  const onSubmit = async (data: CreateGoogleMeetMeetingInput) => {
    try {
      ...
      console.error('[CreateGoogleMeetMeetingDialog] Submit error:', error);
    }
  };
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Schedule a new Google Meet meeting. The meeting will be added to your Google Calendar and attendees will receive an invite.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="flex flex-col items-center justify-center py-4 text-center">
              ...
              <p className="text-sm text-muted-foreground max-w-sm">
                Your Google Meet meeting has been scheduled and added to your Google Calendar. Share the link below with attendees.
              </p>
            </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Meeting agenda, notes, or additional information..."
                        {...field}
                        disabled={createMeeting.isPending}
                        rows={3}
                      />
              ...
              <div className="space-y-2">
                ...
                <FormDescription className="text-xs">
                  Press Enter to add each attendee. They'll receive an email invite via Google Calendar.
                </FormDescription>
              </div>
